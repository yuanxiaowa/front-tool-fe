...
export function addDir(item) {
    return instance.post('dir/add', item);
}
export function fetchProjects(dir) {
...
export function fetchModules(dir) {
    return axios.get('/api/files', {
        params: {
            pattern: dir + '/modules/*'
        }
...
export function fetchImages(dir) {
    return axios.get('/api/files', {
        params: {
...
export function fetchDatas(dir) {
    return axios.get('/api/files', {
        params: {
